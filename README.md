...
| Skill | Description |
|-------|-------------|
| [open-parliament](open-parliament/) | Multi-agent deliberation system modeled on representative democracy. Spawns a parliament of AI agents with diverse personalities to debate problems through structured rounds of Q&A, amendment, and voting. |
...
1. Create a directory at the repo root named after the skill
